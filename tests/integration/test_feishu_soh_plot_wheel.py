...
RUL_UPSTREAM_SHA256 = (
    "c1382ceaa30e7160e2ce10ce0f1474e590c4fd82b9014a0ac2b7d142aa09d67c"
)
...
def test_feishu_soh_plot_assets_are_present_and_provenanced_in_wheel(
    ...
    with zipfile.ZipFile(wheels[0]) as archive:
        members = {
            ...
            "quanxin_life/integrations/feishu/assets/QuanxinRulSans-Regular.ttf",
            ...
            "quanxin_life/integrations/feishu/assets/RUL_UPSTREAM.json",
        }
        ...
        rul_upstream_bytes = archive.read(
            "quanxin_life/integrations/feishu/assets/RUL_UPSTREAM.json"
        )
    ...
    assert hashlib.sha256(rul_font).hexdigest() == RUL_FONT_SHA256
    ...
    assert hashlib.sha256(rul_upstream_bytes).hexdigest() == RUL_UPSTREAM_SHA256
    ...
    rul_upstream = json.loads(rul_upstream_bytes)
    assert rul_upstream["output_sha256"] == RUL_FONT_SHA256
    assert rul_upstream["license"] == "SIL Open Font License 1.1"
