...
本页描述 Hiro 个人比赛演示的目标部署路径。目标是用一台 4 vCPU、8 GiB
...
当前已发布镜像见 [ACR release `2026.08.02-1`](releases/2026.08.02-1.md)。被替代的
旧 release 和一次性主机审计快照不在产品仓库维护；部署前应按运维 Runbook 重新核验
目标主机、镜像 digest、迁移、备份和回滚状态。
