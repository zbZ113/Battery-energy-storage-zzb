...
from quanxin_life.training.orchestrator import execute_matr_suite  # noqa: E402
from quanxin_life.training.suite import MatrRunConfig, build_run_matrix  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("dataset", choices=("matr", "hust", "naumann-cycle", "naumann-calendar"))
    parser.add_argument("mode", choices=("smoke", "final"))
    parser.add_argument("--plan-only", action="store_true")
    arguments = parser.parse_args()
    if arguments.dataset != "matr":
        print(
            json.dumps(
                {
