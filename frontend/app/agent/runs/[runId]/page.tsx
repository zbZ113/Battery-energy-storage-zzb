...
import { AGENT_EVENT_NAMES, findPendingApproval, isTerminalAgentEvent } from "@/lib/agent-events";
import {
  agentEventsUrl,
  approveAgentRun,
  getAgentRun,
  ...
  return (
    <AppShell>
      ...
      <section className="panel">
        <div className="panel-heading"><Radio /><div><h2>实时事件</h2><p>连接状态：{connection}</p></div></div>
        <SseConnectionNotice
          onReconnect={() => {
